...
> 5分钟快速上手 IndustrialControls 控件库
...
1. 在 Visual Studio 中创建一个新的 Windows Forms App (.NET Framework) 项目
2. 右键项目 → **管理 NuGet 程序包**
3. 安装 `IndustrialControls` 包（或直接引用项目中的 `IndustrialControls.dll`）
...
- 打开 **[控件与核心模块文档索引](./controls/README.md)**，按控件查阅独立说明；或从 [API使用说明书](./API使用说明书.md) 的索引表跳转  
